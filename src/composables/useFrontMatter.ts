...
/**
 * Front-matter 卡片的 CSS 样式（包含 Night 主题适配）
 * 用于 HTML 导出时内联到 <style>，与 PreviewPane scoped 样式保持一致
 */
...
.front-matter-card .fm-key {
  font-weight: 600;
  color: #6a737d;
  min-width: 60px;
  text-transform: capitalize;
}
.front-matter-card .fm-value { color: #24292e; }
.front-matter-card .fm-date { font-variant-numeric: tabular-nums; }
.front-matter-card .fm-tags {
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
  margin-top: 8px;
}
.front-matter-card .fm-tag {
...
.theme-night .front-matter-card { background: #161b22; border-color: #30363d; }
.theme-night .front-matter-card .fm-title { color: #c9d1d9; }
.theme-night .front-matter-card .fm-key { color: #8b949e; }
.theme-night .front-matter-card .fm-value { color: #c9d1d9; }
.theme-night .front-matter-card .fm-tag { background: #1f6feb; }
`;
